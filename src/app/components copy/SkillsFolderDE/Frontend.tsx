...
const Frontend:React.FC = () => {
    return (
        ...
        <Popover title="Next">
        <a href="https://nextjs.org/docs" target="_blank" rel="noreferrer"><img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/skills/nextjs-colored.svg" width="65" height="65" alt="NextJs" /></a>
        </Popover>
        <Popover title="Vercel">
        <a href="https://vercel.com/" target="_blank" rel="noreferrer"><img src="https://assets.vercel.com/image/upload/front/favicon/vercel/180x180.png" width="65" height="65" alt="Vercel" /></a>
        </Popover>
        </div>
        </div>
    )
